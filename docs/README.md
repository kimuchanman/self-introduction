...
以下が主要な取り組みです。
  ...
  - AI/自動化ツールの導入と生産性向上
    ...
    - MCP（Model Context Protocol）サーバーの開発・運用による開発体験の向上
...
これらの活動により、開発チーム全体の生産性向上とコスト削減を同時に実現し、月次で数十万円規模のインフラコスト削減に貢献しました。また、VRT の安定性向上により、開発者の待ち時間を大幅に削減し、CI/CD パイプラインの信頼性を向上させました。
